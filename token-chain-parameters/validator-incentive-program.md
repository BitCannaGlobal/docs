...
*   Wallet
    ...
    o   Description: providing a wallet where users can manage their funds

    o   Prerequisite: free validator choice, users should control their own private keys, code should be open-source
*   Explorer
